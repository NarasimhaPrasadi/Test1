...
public class Reports {
	...
	public void writeIntoFile(WebDriver driver, String testCaseName, String stepSummary, String stepDecription, String ActualResult, String stepStatus, String string, String timeStamp) {
		...
		try {
			...
			if(stepStatus.equals(fail)){
				testStatus = false;
				comlib.captureScreenshot(driver, testCaseName + "_" + timeStamp);
	...
	public void writeIntoFile1(AndroidDriver driver, String testCaseName, String stepSummary, String stepDecription, String ActualResult, String stepStatus, String string, String timeStamp) {
