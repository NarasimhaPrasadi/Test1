...
public class SearchLocationByState 
{
	private ExtLogger log = new ExtLogger(SearchLocationByState.class.toString());
	...
	public void VerifyLocationbyAddress()
	{
		try {
            ...
            locations.LocationSearchByState();
            ...
            try {
            	Assert.assertTrue(locations.isAddressDisplayed());
