...
public class VerifyGpsEnabledLocation 
{
	private ExtLogger log = new ExtLogger(VerifyGpsEnabledLocation.class.toString());
	...
	String moduleName = "Verify Gps Enabled";
