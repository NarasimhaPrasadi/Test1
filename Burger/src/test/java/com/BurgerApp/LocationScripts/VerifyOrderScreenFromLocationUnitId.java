...
public class VerifyOrderScreenFromLocationUnitId 
{
	private ExtLogger log = new ExtLogger(VerifyOrderScreenFromLocationUnitId.class.toString());
	...
	String moduleName = "Verify Oder Screen From Location";
