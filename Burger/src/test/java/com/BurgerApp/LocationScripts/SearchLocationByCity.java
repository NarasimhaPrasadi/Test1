...
public class SearchLocationByCity 
{
	private ExtLogger log = new ExtLogger(SearchLocationByCity.class.toString());
	...
	@Test
	public void VerifyLocationbyCity()
	{
		try {
            ...
            locations.LocatedBurgerStoreCity();          
            locations.addressLayoutTap();    
            locations.LocationbBack();
