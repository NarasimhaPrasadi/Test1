package com.BurgerApp.LaunchScreenScripts;
...
import com.BurgerApp.HomePageScripts.VerifySignUpGooglePlus;
...
public class VerifySignUp 
{
	...
	String moduleName = "Verify SignUp screen";
	...
	@Test
	public void HomeScreenValidations()
	{
		try {
			...
			try {
				...
				reports.writeIntoFile(driver, testCaseName,  "Verify SignUp button", "Verify SignUp button", "SignUp button is verified", reports.pass, "", comlib.getCurrentTime());
			}
			catch(Exception e)
			{
				reports.writeIntoFile(driver, testCaseName,  "Verify SignUp button", "Verify SignUp button", "SignUp button is not verified", reports.fail, e.getMessage(), comlib.getCurrentTime());
			...
			try {
				...
				reports.writeIntoFile(driver, testCaseName,  "Verify SignUp button", "Verify SignIn button", "SignIn button is verified", reports.pass, "", comlib.getCurrentTime());
			}
			catch(Exception e)
			{
				reports.writeIntoFile(driver, testCaseName,  "Verify SignUp button", "Verify SignIn button", "SignIn button is not verified", reports.fail, e.getMessage(), comlib.getCurrentTime());
				log.stepLog("Exception in Verified" +e.getMessage());
				Assert.assertTrue(false);
			}
			...
			try {
				...
				reports.writeIntoFile(driver, testCaseName,  "Verify SignUp screen", "Verify SignUp screen", "SignUp screen is Verified", reports.pass, "", comlib.getCurrentTime());
			}
			catch(Exception e)
			{
				reports.writeIntoFile(driver, testCaseName,  "Verify SignUp screen", "Verify SignUp screen", "SignUp screen is Verified", reports.fail, e.getMessage(), comlib.getCurrentTime());
				log.stepLog("Exception in Verified" +e.getMessage());
				Assert.assertTrue(false);
			}	
