...
public class SearchLocationByInvalidCity 
{
	private ExtLogger log = new ExtLogger(SearchLocationByInvalidCity.class.toString());
	...
	@Test
	public void SearchLocationByInvalidCity_Script()
	{
		...
		try {
            ...
            locations.LocationSearchByInvalidCity();
