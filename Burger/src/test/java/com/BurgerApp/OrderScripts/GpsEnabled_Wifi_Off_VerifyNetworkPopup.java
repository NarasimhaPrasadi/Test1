...
public class GpsEnabled_Wifi_Off_VerifyNetworkPopup 
{
	private ExtLogger log = new ExtLogger(GpsEnabled_Wifi_Off_VerifyNetworkPopup.class.toString());
	...
	@Test
	public void GpsEnabled_Wifi_Off_VerifyNetworkPopupScript()
	{
		try {
