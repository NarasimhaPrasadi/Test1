...
public class ValidateLocationSearch_ZipCode 
{
	private ExtLogger log = new ExtLogger(ValidateLocationSearch_ZipCode.class.toString());
	...
	@Test
	public void ValidateLocationSearch_ZipCodeScript()
	{
		try {
