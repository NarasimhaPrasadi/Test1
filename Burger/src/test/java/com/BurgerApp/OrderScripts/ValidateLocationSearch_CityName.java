...
public class ValidateLocationSearch_CityName 
{
	private ExtLogger log = new ExtLogger(ValidateLocationSearch_CityName.class.toString());
	...
	@Test
	public void ValidateLocationSearch_CityNameScript()
	{
		try {
