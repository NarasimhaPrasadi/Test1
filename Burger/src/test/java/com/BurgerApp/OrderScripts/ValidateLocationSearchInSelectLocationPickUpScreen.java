...
public class ValidateLocationSearchInSelectLocationPickUpScreen 
{
	private ExtLogger log = new ExtLogger(ValidateLocationSearchInSelectLocationPickUpScreen.class.toString());
