...
public class VerifyNetworkPopupFavouriteTabTapLink 
{
	private ExtLogger log = new ExtLogger(VerifyNetworkPopupFavouriteTabTapLink.class.toString());
	...
	@Test
	public void VerifyNetworkPopupFavouriteTabTapLinkScript()
	{
