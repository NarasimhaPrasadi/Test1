...
public class ValidateLocationSearch_CityGpsEnabled 
{
	private ExtLogger log = new ExtLogger(ValidateLocationSearch_CityGpsEnabled.class.toString());
	...
	@Test
	public void ValidateLocationSearch_CityGpsEnabledScript()
	{
		try {
            ...
            try {
            	Assert.assertTrue(locations.isLocatedBurgerStoreByCity());
