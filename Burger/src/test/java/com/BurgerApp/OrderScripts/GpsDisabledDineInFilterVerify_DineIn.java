...
public class GpsDisabledDineInFilterVerify_DineIn 
{
	private ExtLogger log = new ExtLogger(GpsDisabledDineInFilterVerify_DineIn.class.toString());
	...
	String moduleName = "GpsDisabledDineInFilterVerify_DineInScript";
	...
	@Test
	public void GpsDisabledDineInFilterVerify_DineInScript()
	{
		try {
