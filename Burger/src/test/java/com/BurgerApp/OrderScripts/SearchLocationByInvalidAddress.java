...
public class SearchLocationByInvalidAddress 
{
	private ExtLogger log = new ExtLogger(SearchLocationByInvalidAddress.class.toString());
	...
	public void VerifyAssertListByOrderScreen()
	{
		...
		try {
            ...
            locations.LocationSearchByInValidAddress();
