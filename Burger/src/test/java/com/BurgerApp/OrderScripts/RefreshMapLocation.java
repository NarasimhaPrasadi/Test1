...
public class RefreshMapLocation 
{
	private ExtLogger log = new ExtLogger(RefreshMapLocation.class.toString());
	...
	@Test
	public void VerifyVerifyCenteredLocationByCity()
	{
		try {
            ...
            locations.LocationSearchByCitySanantonio();
            comlib.tapSearchKey(driver);           
            locations.RefreshLocationStore(driver);	           
            locations.RefreshButton();
			} catch (Exception e) {
