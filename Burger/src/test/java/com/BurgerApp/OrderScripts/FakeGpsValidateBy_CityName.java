...
public class FakeGpsValidateBy_CityName 
{
	private ExtLogger log = new ExtLogger(FakeGpsValidateBy_CityName.class.toString());
	...
	String moduleName = "Verify Location by City";
	...
	@Test
	public void FakeGpsValidateBy_CityNameScript()
	{
		try {
            ...
            try {
            	Assert.assertTrue(locations.IsAustinStoreByFakeGpsDisplayed());
