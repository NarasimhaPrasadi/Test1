...
public class ValidateLocationSearch_AddressWithGPSEnabled 
{
	private ExtLogger log = new ExtLogger(ValidateLocationSearch_AddressWithGPSEnabled.class.toString());
	...
	@Test
	public void ValidateLocationSearch_ValidAddressScript()
	{
		try {
