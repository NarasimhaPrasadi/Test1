...
public class ValidateLocationSearch_CountryName 
{
	private ExtLogger log = new ExtLogger(ValidateLocationSearch_CountryName.class.toString());
	...
	@Test
	public void ValidateLocationSearch_CountryNameScript()
	{
		try {
