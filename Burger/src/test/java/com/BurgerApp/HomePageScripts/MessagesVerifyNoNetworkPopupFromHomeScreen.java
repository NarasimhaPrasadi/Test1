...
public class MessagesVerifyNoNetworkPopupFromHomeScreen 
{
	private ExtLogger log = new ExtLogger(MessagesVerifyNoNetworkPopupFromHomeScreen.class.toString());
	...
	@Test
	public void MessagesVerifyNoNetworkPopupFromHomeScreenScript()
	{
		try {
			...
			home.Fbskip();
			home.WifiDisable();
			comlib.swipeHorizontalUntilTextMatched(driver, "Messages", 0.70);		
