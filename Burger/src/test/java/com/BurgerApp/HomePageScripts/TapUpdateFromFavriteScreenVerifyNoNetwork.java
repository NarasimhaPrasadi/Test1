...
public class TapUpdateFromFavriteScreenVerifyNoNetwork 
{
	private ExtLogger log = new ExtLogger(TapUpdateFromFavriteScreenVerifyNoNetwork.class.toString());
	...
	@Test
	public void TapUpdateFromFavriteScreenVerifyNoNetworkScript()
	{
		try {
