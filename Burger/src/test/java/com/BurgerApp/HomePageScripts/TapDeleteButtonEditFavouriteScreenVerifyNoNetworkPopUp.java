...
public class TapDeleteButtonEditFavouriteScreenVerifyNoNetworkPopUp 
{
	private ExtLogger log = new ExtLogger(TapDeleteButtonEditFavouriteScreenVerifyNoNetworkPopUp.class.toString());
	...
	@Test
	public void TapDeleteButtonEditFavouriteScreenVerifyNoNetworkPopUpScript()
	{
		try {
