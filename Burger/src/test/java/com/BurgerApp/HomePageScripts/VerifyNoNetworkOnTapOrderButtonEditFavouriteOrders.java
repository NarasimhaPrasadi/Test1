...
public class VerifyNoNetworkOnTapOrderButtonEditFavouriteOrders 
{
	private ExtLogger log = new ExtLogger(VerifyNoNetworkOnTapOrderButtonEditFavouriteOrders.class.toString());
	...
	@Test
	public void VerifyNoNetworkOnTapOrderButtonEditFavouriteOrdersScript()
	{
		try {
