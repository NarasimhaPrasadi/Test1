...
public class TapEditFavouriteHamburgMenuVerifyNoNetworkPopUp 
{
	private ExtLogger log = new ExtLogger(TapEditFavouriteHamburgMenuVerifyNoNetworkPopUp.class.toString());
	...
	@Test
	public void TapEditFavouriteHamburgMenuVerifyNoNetworkPopUpScript()
	{
		try {
