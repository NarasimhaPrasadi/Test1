...
public class VerifyNoNetworkOnTapRenameContinueButton 
{
	private ExtLogger log = new ExtLogger(VerifyNoNetworkOnTapRenameContinueButton.class.toString());
	...
	@Test
	public void VerifyNoNetworkOnTapRenameContinueButtonScript()
	{
		try {
