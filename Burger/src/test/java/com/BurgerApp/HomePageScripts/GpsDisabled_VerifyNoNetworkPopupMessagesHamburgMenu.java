...
public class GpsDisabled_VerifyNoNetworkPopupMessagesHamburgMenu 
{
	private ExtLogger log = new ExtLogger(GpsDisabled_VerifyNoNetworkPopupMessagesHamburgMenu.class.toString());
	...
	@Test
	public void VerifyNoNetworkPopupMessagesHamburgMenuScript()
	{
		try {
